...
function init() {
    ...
    EnterpriseMap.addLayers([ openstreetmap, objects, userObjects]);
    ...
    var select = new OpenLayers.Control.SelectFeature([ objects ], {
        ...
        onSelect : function(feature) {
            ...
            xy = EnterpriseMap.getPixelFromLonLat(new OpenLayers.LonLat(
    ...
    EnterpriseMap.addControl(select);
    select.activate();

    ResizeMap(37, 55);
    EnterpriseMap.zoomTo(6);
